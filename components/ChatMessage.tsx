...
interface ChatMessageProps {
  message: Message;
  isLoading?: boolean;
  isOutOfContext?: boolean; // New prop
}

export const ChatMessage: React.FC<ChatMessageProps> = ({ message, isLoading = false, isOutOfContext = false }) => {
  ...
  return (
    <div className={`... ${isOutOfContext ? 'opacity-50' : ''}`}>
