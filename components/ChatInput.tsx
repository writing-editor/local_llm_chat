...
export const ChatInput: React.FC<ChatInputProps> = ({ onSendMessage, isLoading, isModelReady }) => {
    ...
    const getPlaceholder = () => {
        ...
        return "Ask me to draft a letter, email, or anything else...";
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="p-4 bg-white/80 backdrop-blur-sm border-t border-gray-200">
            <div className="relative flex items-end">
                ...
                <button
                    type="submit"
                    disabled={isLoading || !input.trim() || !isModelReady}
